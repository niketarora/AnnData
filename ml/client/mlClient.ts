...
} from '../contracts/mlServices.contract.js';
...
export class MLClient {
  ...
  /**
   * Calls OASSM-10 Price Prediction Endpoint
   */
  ...
  /**
   * Calls CatBoost Selling Recommendation Endpoint
   */
  ...
  /**
   * Calls Computer Vision Quality Assessment Endpoint
   */
